...
if [ $? -eq 0 ]; then
   ...
   python3 cmscontrib/AddAdmin.py $(python3 cmscontrib/misit/config_reader.py admin_user) -p  $(python3 cmscontrib/misit/config_reader.py admin_password) 2>&1 | tee -a /var/log/cms/addadmin
else
